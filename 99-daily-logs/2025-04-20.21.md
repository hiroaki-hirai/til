...
|--- | --- | --- | ---|
|バッファオーバーフロー | 配列などの境界を超えてメモリを書き換える | 境界チェックなし (gets, strcpy, etc.) | - Stack Canary
- strncpy, fgets など安全な関数の使用
- ASLR
- コンパイラの警告 (-Wall, -Wextra)|
